...
AS
  ...
  BEGIN
    ...
    SET IDENTITY_INSERT dss_fact_table ON
    INSERT INTO dss_fact_table
    ( dss_fact_table_key
    , dss_fact_table_name
    , dss_fact_table_type
    )
    ...
    SET IDENTITY_INSERT dss_fact_table OFF
  ...
  BEGIN
    ...
    BEGIN
      INSERT INTO dss_fact_table --primary key is populated with an IDENTITY value
      ( dss_fact_table_name
      , dss_fact_table_type
      )
      VALUES
